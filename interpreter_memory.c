...
uint32_t RomFileSize = 0x4000000;
    ...
    case 0x00700000:
        if (PAddr < RdramSize)
        {
            ...
            *(uint8_t *)(N64MEM+PAddr) = Value;
            if (N64_Blocks.NoOfRDRamBlocks[(PAddr & 0x00FFFFF0) >> 12] == 0)
            {
                break;
            }
...
//          }
    ...
    case 0x04600000:
        ...
        case 0x04600020:
            ...
            break;
        case 0x04600024:
            PI_DOMAIN2_REG = (Value & 0xFF);
            break;
        case 0x04600028:
            PI_BSD_DOM2_PWD_REG = (Value & 0xFF);
            break;
        case 0x0460002C:
            PI_BSD_DOM2_PGS_REG = (Value & 0xFF);
            break;
        case 0x04600030:
            PI_BSD_DOM2_RLS_REG = (Value & 0xFF);
            break;
        default:
            return 0;
        }
