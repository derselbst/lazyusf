...
#define SetJump32(Loc,JumpLoc) *(uint32_t *)(Loc)= (uint32_t)(((uintptr_t)(JumpLoc)) - (((uintptr_t)(Loc)) + 4));

//#define SetJump8(Loc,JumpLoc)  *(uint8_t  *)(Loc)= (uint8_t )(((uint8_t )(JumpLoc)) - (((uint8_t )(Loc)) + 1));
#define SetJump8(Loc,JumpLoc)  *(uint8_t  *)(Loc)= (uint8_t )(((uintptr_t)(JumpLoc)) - (((uintptr_t)(Loc)) + 1));
