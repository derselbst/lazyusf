...
int32_t Free8BitX86Reg (BLOCK_SECTION * Section)
{
    ...
    if (x86Mapped(x86_EBX&0x2f) == NotMapped && !x86Protected(x86_EBX&0x2f))
    {
        return x86_EBX;
    }
    if (x86Mapped(x86_EDX&0x2f) == NotMapped && !x86Protected(x86_EDX&0x2f))
    {
        return x86_EDX;
    }
    if (x86Mapped(x86_ECX&0x2f) == NotMapped && !x86Protected(x86_ECX&0x2f))
    {
        return x86_ECX;
    }
    if (x86Mapped(x86_EAX&0x2f) == NotMapped && !x86Protected(x86_EAX&0x2f))
    {
        return x86_EAX;
    }
#ifdef EXT_REGS
    if (x86Mapped(x86_R9D&0x2f) == NotMapped && !x86Protected(x86_R9D&0x2f))
    {
        return x86_R9D;
    }
    if (x86Mapped(x86_R10D&0x2f) == NotMapped && !x86Protected(x86_R10D&0x2f))
    {
        return x86_R10D;
    }
    if (x86Mapped(x86_R11D&0x2f) == NotMapped && !x86Protected(x86_R11D&0x2f))
    {
        return x86_R11D;
    }
    if (x86Mapped(x86_R14D&0x2f) == NotMapped && !x86Protected(x86_R14D&0x2f))
    {
        return x86_R14D;
    }
#endif
...
int32_t FreeX86Reg (BLOCK_SECTION * Section)
{
    ...
    if (x86Mapped(x86_ESI&0x2f) == NotMapped && !x86Protected(x86_ESI&0x2f))
    {
        return x86_ESI;
    }
    if (x86Mapped(x86_EDI&0x2f) == NotMapped && !x86Protected(x86_EDI&0x2f))
    {
        return x86_EDI;
    }
    if (x86Mapped(x86_EBX&0x2f) == NotMapped && !x86Protected(x86_EBX&0x2f))
    ...
    if (x86Mapped(x86_R12D&0x2f) == NotMapped && !x86Protected(x86_R12D&0x2f))
    {
        return x86_R12D;
    }
    if (x86Mapped(x86_R13D&0x2f) == NotMapped && !x86Protected(x86_R13D&0x2f))
    {
        return x86_R13D;
    }
    if (x86Mapped(x86_R14D&0x2f) == NotMapped && !x86Protected(x86_R14D&0x2f))
...
int32_t Map_TempReg (BLOCK_SECTION * Section, int32_t x86Reg, int32_t MipsReg, uint32_t LoadHiWord)
{
    ...
    {
        if (x86Mapped(x86_EBX&0x2f) == Temp_Mapped && !x86Protected(x86_EBX&0x2f))
        {
            x86Reg = x86_EBX;
        }
        if (x86Mapped(x86_EAX&0x2f) == Temp_Mapped && !x86Protected(x86_EAX&0x2f))
        {
            x86Reg = x86_EAX;
        }
        if (x86Mapped(x86_EDX&0x2f) == Temp_Mapped && !x86Protected(x86_EDX&0x2f))
        {
            x86Reg = x86_EDX;
        }
        if (x86Mapped(x86_ECX&0x2f) == Temp_Mapped && !x86Protected(x86_ECX&0x2f))
        {
            x86Reg = x86_ECX;
        }

#ifdef EXT_REGS
        if (x86Mapped(x86_R9D&0x2f) == Temp_Mapped && !x86Protected(x86_R9D&0x2f))
        {
            x86Reg = x86_R9D;
        }
        if (x86Mapped(x86_R10D&0x2f) == Temp_Mapped && !x86Protected(x86_R10D&0x2f))
        {
            x86Reg = x86_R10D;
        }
        if (x86Mapped(x86_R11D&0x2f) == Temp_Mapped && !x86Protected(x86_R11D&0x2f))
        {
            x86Reg = x86_R11D;
        }
        if (x86Mapped(x86_R14D&0x2f) == Temp_Mapped && !x86Protected(x86_R14D&0x2f))
        {
            x86Reg = x86_R14D;
        }
#endif
